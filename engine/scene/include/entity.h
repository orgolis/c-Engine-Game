...
public:
    ...
    NpcAgentComponent* GetNpcAgentComponent() { return &npc_agent_component_; }
    const NpcAgentComponent* GetNpcAgentComponent() const { return &npc_agent_component_; }
...
protected:
    ...
    NpcAgentComponent npc_agent_component_;
