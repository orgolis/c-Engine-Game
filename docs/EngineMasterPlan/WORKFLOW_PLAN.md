...
| 9.2 | **Linux** (+ the headless dedicated server) | engine | 🟡 **Desktop landed early, in PR #70 (v0.8.5)** — editor, `dedicated_server` and all checks build and pass on Ubuntu CI; #71 added the terminal; releases carry a Linux package from 0.8.5. Remaining: C++/C# script hosts, crash stacks, installing through the Hub; see REMAINING_WORK Stage 13 |
